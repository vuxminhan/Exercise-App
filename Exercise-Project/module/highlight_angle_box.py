...
def highlight_angle_box(inpath1, inpath2, path, mat1, mat2, outpath1, outpath2):
    ...
    while cap1.isOpened() or cap2.isOpened():
        ...
        for i in path:
            ...
            if okay2: 
                img2 = draw_bounding_box_around_body_parts(frame2, wrong_angle_list)
                cv2.rectangle(img2, (0,0), (120, 200), (80,30,20), -1)
                y0, dy = 20, 20
                for i, line in enumerate(message.split('\n')):
                    y = y0 + i*dy
                    cv2.putText(img2, line, (10, y ),2, 0.3, (250,250,250),1, lineType = cv2.LINE_AA )     
